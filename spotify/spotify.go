...
// Usage:
// 	spotify.New("XXX","YYY")
func New(clientID string, clientSecret string, accessToken string) Spotify {

	return initialize(clientID, clientSecret, accessToken)
}

func initialize(clientID string, clientSecret string, accessToken string) Spotify {
	spot := Spotify{clientID: clientID, clientSecret: clientSecret, accessToken: accessToken}
	return spot
}
